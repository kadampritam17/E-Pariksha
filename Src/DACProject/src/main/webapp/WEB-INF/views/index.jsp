        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Pune, PU 535022,<br>
              Maharastra <br><br>
              <strong>Phone:</strong> +91 9988778899<br>
              <strong>Email:</strong> epariksha@gmail.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h3>E-Pariksha</h3>
            <p>A fully integrated platform for providing end to end online computer based examination services from
              candidate registration to result processing.</p>
