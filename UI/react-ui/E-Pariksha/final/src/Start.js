...
export default function Start() {
    return (
        ...
        <div>
            ...
            <center>
                <div className="">
                    <div className="card" style={{ 'margin-top': '100px', width: '100rem', height: '45rem' }}>
                        {/* <div className="info-title"><span>Some Rules of this Quiz</span></div> */}
                        <div className="card-body">
                            <div style={{ 'text-align': 'justify' ,width:'90rem' }}>
                                {/* <div>Centralised Course End Examination (CCEE) Online PG Diploma September 2021 batch</div> */}
                                <div className="text-center"><h1 className="card-title" style={{'font-size':'25px'}}><strong>INSTRUCTIONS TO STUDENTS</strong></h1></div>
                                <hr></hr>
