        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="teacher.html">Teacher</a></li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
   ...
   -->
                            ...
                            <form class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault01" value="" name="first_name" placeholder="First name"
                                        required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="validationDefault02" value="" name="mob_no" placeholder="Moblie No"
                                        required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault02" value="" name="user_name" placeholder="User name"
                                        required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="validationDefault02" value="" name="email" placeholder="Email ID"
                                        required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault02" value="" name="qualification" placeholder="Qualification"
                                        required>
                                </div>
                                
                                <div class="col-md-6">
                                    <label for="validationDefault02" class="form-label">Year of Experience</label>
                                    <input type="number" class="form-control" id="validationDefault02" value="" name="year_of_exp" placeholder="Year of Experience"
                                        required>
                                </div>
